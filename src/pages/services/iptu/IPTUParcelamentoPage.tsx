      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button onClick={() => (simular as any).mutate()} variant="secondary" disabled={!debitos?.length || (simular as any).isPending}>Simular</Button>
            <Button onClick={() => (efetivar as any).mutate()} variant="default" disabled={!simular.data?.length || (efetivar as any).isPending}>Confirmar e gerar boletos</Button>
          </div>
